          ...
          <form role="form" action="<?php base_url('users/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="stock" name="stock" placeholder="Enter stock" autocomplete="off"  required />
                </div>

                <div class="form-group">
                  <label for="qty">Left Items</label>
                  <input type="number" class="form-control" id="qty" name="qty" placeholder="Enter Qty" autocomplete="off" required  />
                </div>
