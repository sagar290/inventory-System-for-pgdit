...
class Model_orders extends CI_Model
{
    ...
    public function getOrdersItemData($order_id = null)
    {
        ...
        $sql = "SELECT orders_item.*, products.qty AS inventory_qty FROM orders_item JOIN products ON products.id = orders_item.product_id WHERE order_id = ? ";
    ...
    public function create()
    {
        ...
        $data = array(
            ...
            'delivery_charge' => ($this->input->post('delivery_charge') > 0) ? $this->input->post('delivery_charge') : 0,
	...
	public function updateProductQty($order_id) {
		...
		foreach ($order_items as $item) {
			...
			$qty = (int) $product_data['qty'] + (int) $item['qty'];
			...
			$this->model_products->update($update_product, $item['product_id']);
		}
	}
}
